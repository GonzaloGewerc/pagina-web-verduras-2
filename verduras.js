...
(function() {
  ...
  function setupMenuAutoClose() {
    ...
    // Selecciona los links del menú dentro del <nav>
    const links = document.querySelectorAll('nav ul li a');

    // Cierra al hacer click/tap en cualquier opción
    const closeMenu = () => {
      // Solo tiene sentido en móvil (tu CSS muestra overlay en <=800px)
    ...
    links.forEach(link => {
      // Algunos navegadores “navegan” muy rápido: cubrimos varios eventos
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // <<--- activar cierre automático del menú móvil
    setupMenuAutoClose();
  });
